...
namespace Project_CatTech.Layer.Entities.BCR
{
    public class ServicesBCCR
    {
        //Agregar los credenciales para el uso del consumo API del Dolar BCCR
        private readonly string TOKEN = "N40O2G006I";
        private readonly string NOMBRE = "Emanuel";
        private readonly string CORREO = "emanuelmadrigal096@gmail.com";
